Selenium.prototype.doLipsumText = function( options, varName ) {
    ...
    switch (type) {
        case 'paragraphs' : storedVars[varName] = lipsumParagraphs(length, useHtmlTags); break;
        case 'words' : storedVars[varName] = lipsumWords(length); break;
        default  : storedVars[varName] = lipsumWords(length);
    };
};
...
// Modified by Adam Courtemanche (agileadam) 2012-06-01
//
